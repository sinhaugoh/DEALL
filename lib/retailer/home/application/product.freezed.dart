    ...
    return _then(_value.copyWith(
      ...
      description: description == freezed
          ...
          : description // ignore: cast_nullable_to_non_nullable
              as String?,
      availablity: availablity == freezed
          ? _value.availablity
...
class _$_Product implements _Product {
  ...
  @override
  String toString() {
    return 'Product(name: $name, usualPrice: $usualPrice, discountPrice: $discountPrice, image: $image, description: $description, availablity: $availablity)';
  }
    ...
    return identical(this, other) ||
        (other is _Product &&
            ...
            (identical(other.availablity, availablity) ||
                const DeepCollectionEquality()
                    .equals(other.availablity, availablity)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(availablity);
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      String? image,
      String? description,
      required bool availablity}) = _$_Product;
